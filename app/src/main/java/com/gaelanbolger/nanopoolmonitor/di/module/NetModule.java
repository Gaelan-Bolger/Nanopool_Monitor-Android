...
import com.gaelanbolger.nanopoolmonitor.util.LiveDataCallAdapterFactory;
...
public class NetModule {
    ...
    @Provides
    @Singleton
    NanopoolService provideNanopoolService(@Named("baseUrl") String baseUrl,
